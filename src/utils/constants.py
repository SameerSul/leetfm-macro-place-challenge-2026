...
HIER_SOFT_TAG_PREFIX_MAX_DEPTH = 5
HIER_SOFT_TAG_PREFIX_MIN_GROUP = 2
HIER_SOFT_TAG_PREFIX_MIN_COVERAGE = 0.25
HIER_SOFT_BUNDLE_MAX_FANOUT = 8
HIER_SOFT_BUNDLE_MIN_SHARED_NETS = 2
HIER_SOFT_BUNDLE_EDGE_RATIO = 0.60
HIER_SOFT_BUNDLE_MAX_SIZE = 16
HIER_SOFT_BUNDLE_HIGH_CONFIDENCE = 0.90
HIER_SOFT_BUNDLE_MEDIUM_CONFIDENCE = 0.75
