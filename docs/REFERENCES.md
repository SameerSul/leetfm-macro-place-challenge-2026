...
| Optional live visualization | [PyQtGraph 0.14 documentation](https://pyqtgraph.readthedocs.io/en/latest/), [PySide6 package metadata](https://pypi.org/project/PySide6/), [ImageIO documentation](https://imageio.readthedocs.io/), [imageio-ffmpeg package metadata](https://pypi.org/project/imageio-ffmpeg/) |
