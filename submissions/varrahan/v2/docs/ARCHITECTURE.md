...
Headline (`--all`, 2026-05-31 — full stack): **avg `1.1993`** — beats
RePlAce (1.4578) by **17.7%** and the UT Austin DREAMPlace leaderboard (1.4076)
by **14.8%**. All 17 IBM benchmarks VALID / 0 overlaps, bit-exact verified.
