...
flowchart TD
    ...
    HR3 --> SR1[Soft relocation by congestion field if not skipped]
    SR1 --> SR2[Soft relocation by density field]
    SR2 --> SS1[Soft-soft 2-opt by congestion field if not skipped]
    SS1 --> SS2[Soft-soft 2-opt by density field if not skipped]
    ...
    HS32 --> R2O[Hard 2-opt cleanup, k=20 plus S9 cold-teleport]
