...
def main() -> int:
    ...
    print(f"REQUIRE_CUDA={os.environ.get('REQUIRE_CUDA', '')}")
    print(f"RELOC_PROPOSE_CHUNK_SIZE={os.environ.get('RELOC_PROPOSE_CHUNK_SIZE', '')}")
    print(f"RELOC_PROPOSE_MAX_MB={os.environ.get('RELOC_PROPOSE_MAX_MB', '')}")
    print(f"RELOC_PROPOSE_AUTO_MEM_FRAC={os.environ.get('RELOC_PROPOSE_AUTO_MEM_FRAC', '')}")
    print(f"RELOC_PROPOSE_MEM_SAFETY={os.environ.get('RELOC_PROPOSE_MEM_SAFETY', '')}")
